...
public class RightPosFrameGrabber extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat rgba) {
        ...
        mask2 = rgba.width() - (rgba.width()/2*1.2);
        ...
        Imgproc.rectangle(workingMat, new Point(rgba.width(), 0), new Point(mask2, rgba.height()), new Scalar(255, 255, 255), -1, 8, 0);
        Imgproc.rectangle(rgba, new Point(rgba.width(), 0), new Point(mask2, rgba.height()), new Scalar(255, 255, 255), -1, 8, 0);
